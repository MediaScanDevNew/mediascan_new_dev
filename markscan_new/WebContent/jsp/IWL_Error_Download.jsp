...
<title>IWL Errorfile Download</title>
<style type="text/css">
...
<body>
	<s:form method="post" action="iwl_error_download_file" theme="simple">
			...
			<table>
				<tr>
					...
					<td><s:select id="projecttype" name="projecttype"
							list="listDataproj" listKey="id" listValue="name" headerKey="0"
