...
<body>
	...
	<div style="margin-left: 170px;">
		...
		<s:form method="post" action="gtrackerAction">

			<%-- 	<s:hidden id="browser_name" name="browser_name" value="<%=browser %>"><%=browser%></s:hidden> --%>
 ...
 --%>
			...
			<s:submit value="Google Tracker"></s:submit>
	...
	<div>
		<h3 style="color: red;">Use Mozilla Firefox for best results !!!</h3>
	</div>
</body>
</html>
