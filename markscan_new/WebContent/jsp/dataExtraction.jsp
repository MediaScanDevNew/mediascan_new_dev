...
<body>
	<div style="margin-left: 170px;">
		<s:form method="post" action="dataExtracted">
				...
				<s:select label="Select Data Type" headerKey="0"
					headerValue="Infringing Link"
					list="#{'1':'Source Link'}" name="datatype"
			...
			<%-- 	<s:select label="Notification status" headerKey=""
					...
					value="2" cssStyle="width: 170px;" /> --%>
				<s:select id="usertype" name="usertype" list="usrData" listKey="name"
					listValue="name" headerKey="" headerValue="Select User"
				...
				<display:table id="infos" name="infos" pagesize="1"
					...
					<display:column property="clientName" title="DMCA Reported" />
