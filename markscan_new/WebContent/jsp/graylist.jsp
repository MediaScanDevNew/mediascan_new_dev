			...
			<div class="right_col" role="main" >
				<div class="">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<form class="form-group row"  onsubmit="addGrayListUrl(this)">
								<label for="clientId" class="col-md-1 col-sm-1 col-form-label">Select Client:</label>
							    <div class="col-md-2 col-sm-2">
							      <select class="form-control" id="clientId" name="clientId" onchange="onClientChangeGrayList()">
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content border-0">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" class="btn btn-primary border-0" onclick="editGreyList()">Save changes</button>
	      </div>
	    </div><!-- /.modal-content -->
	  </div><!-- /.modal-dialog -->
	</div><!-- /.modal -->
	<div class="modal fade" tabindex="-1" role="dialog" id="deleteConfirm">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content border-0">
	      ...
	      <div class="modal-footer">
	        <button type="button" class="btn btn-default border-0" data-dismiss="modal">Close</button>
	        <button type="button" class="btn btn-danger border-0" onclick="deleteGreyList()">Delete</button>
	      </div>
	    </div><!-- /.modal-content -->
	  </div><!-- /.modal-dialog -->
	</div><!-- /.modal -->
