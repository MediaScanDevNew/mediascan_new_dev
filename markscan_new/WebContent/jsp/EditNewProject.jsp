...
<div style="margin-left: 170px;">
    ...
    <s:form method="post" action="updateProject">
        ...
        <s:select id="projecttype" name="projecttype" list="project_type_Data"
                  ...
                  cssStyle="width: 170px;" value="%{projecttype}" disabled="true"/>
        ...
        <s:textfield name="propertyName_name" id="propertyName_name" placeholder="Property Name" label="Property Name"
                     value="%{project_name}"> </s:textfield> &nbsp;
        <s:checkbox name="checkMe" id="initCaps" label="Initial Caps OFF"/>

        <s:textfield name="file_attach_link" placeholder="LoA (Letter of Authorization)"
                     label="LoA (Letter of Authorization)" value="%{file_attach_link}"> </s:textfield>

        <s:textfield name="actual_hosted_site" placeholder="Official URL" label="Official URL"
        ...
        <s:textfield name="genre" id="genre" placeholder="Genre" label="Genre"
                     value="%{genre}" cssClass="myclass" readonly="true"> </s:textfield> &nbsp;
        <s:hidden name="genre_id" id="genre_id" value="%{genre_id}"/>
        <s:if test="%{projecttype ==4}">
            <table style="display: block;" width="300" id="tv_content_tbl">
                ...
                <tr>
                    <td style="width: 68px;"><s:textfield style="width: 110px;" name="telecastTime"
                                                          label="Telecast Time" id="telecastTime1"
                                                          value="%{ttime}"/></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    <td>
                        <s:textfield name="channel_name" id="channel_name" placeholder="Channel Name"
                                     label="Channel Name" value="%{channel_name}"> </s:textfield>
                        <s:checkbox name="checkMe" id="initCaps1" label="Initial Caps OFF"/>
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td><s:submit value="Update Project"></s:submit></td>
                </tr>
                </tbody>
            </table>
        </s:if>
                    ...
                    <tr>
                        <td rowspan="2" align="left">
                            <table style="display: none;border: none;" id="archive_td">
                                ...
                                <tr>
                                    <td style="width: 110px;">&nbsp;<input type="checkbox" name="archives" value="sun">Sun
                                    </td>
                                    <td style="width: 110px;">&nbsp;<input type="checkbox" name="archives" value="mon">Mon
                                    </td>
                                    <td style="width: 110px;">&nbsp;<input type="checkbox" name="archives" value="tue">Tue
                                    </td>
                                    <td style="width: 110px;">&nbsp;<input type="checkbox" name="archives" value="wed">Wed
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td style="width: 110px;">&nbsp;<input type="checkbox" name="archives" value="thu">Thu
                                    </td>
                                    <td style="width: 110px;">&nbsp;<input type="checkbox" name="archives" value="fri">Fri
                                    </td>
                                    <td style="width: 110px;">&nbsp;<input type="checkbox" name="archives" value="sat">Sat
                                    </td>
                        ...
                        <td rowspan="2" align="left">
                            <table style="display: block;border: none;" id="archive_td">
                                ...
                                <tr>
                                    ...
                                    %>
                                    <td><input type="checkbox" name="archives" value="<%=days2[i]%>"
                                               checked><%=days2[i]%>&nbsp;
                                    </td>
                                    <%
                                        }
...
<script type="text/javascript">
    let genreId;
    /**
     * Changed by Pentation/m on 17/01/20.
     * For Displaying genre,
     */
