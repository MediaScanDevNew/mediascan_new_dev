...
<body>
	...
	<div style="margin-left: 170px;">
		...
		<s:form method="post" action="bl_dataEXPORT">


			 <s:select id="projecttype" name="projecttype" list="listDataUser"
				listKey="id" listValue="name" headerKey="0"
				headerValue="Select User" label="Select Project"
 ...
 --%>
			<%--  <s:select label="Select Data Type" headerKey="-1"
				...
				<s:select label="Select Data Type" headerKey="0"
				headerValue="Select Data"
				list="#{'1':'Not Auto Upload Data'}" name="d_type"
				id="d_type" value="2" cssStyle="width: 170px;" />  
...
<hr>
<%-- <s:textfield label="Start Date" name="err" id="err"
				cssStyle="width: 170px;" value="<s:property value="err_MSG" />"></s:textfield> --%>
<input type="text" value='<s:property value="err_MSG" />' >
