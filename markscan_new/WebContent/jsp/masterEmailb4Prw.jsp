...
<body>
<h1>Master Email / Email Export</h1>
	...
	<div style="margin-left: 170px;">
		...
		<s:form method="post" action="masterEmailchooseProject">
		...
		<s:checkbox name="socialmedia__c" fieldValue="true"
				label="Check Me for only Social Media" />
