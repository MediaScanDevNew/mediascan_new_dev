...
<body>
	<div>
		<form action="verifydata" name="form1" method="post">
			...
			<table cellspacing="1" class="tablesorter">
				<thead>
					...
					<tr>
						...
						<th class="c">Search Keyword</th>

						<th class="b">Infringing</th>

						<th class="b">Infringing II</th>
						<th class="b">Source</th>
						<th  class="c">Edit</th>
					</tr>
				</thead>
				...
				<s:iterator value="blkdata4show">
					...
					<tr id="row<s:property value="id" />"
						...
						<td id="project" class="c"><s:property value="projectid" /></td>
						<!-- project name -->
						<td id="name_row<s:property value="id" />" class="c"><s:property
								value="domain" /></td>
						<!-- DOMAIN name -->
						<td id="name_row1<s:property value="id" />" class="c"><s:property
								value="search_keyword" /></td>

						<td class="b" id="country_row<s:property value="id" />"><s:property
								value="infringing_link_by_date" /></td>
						<td class="b" id="country_row1<s:property value="id" />"><s:property
								value="infringing_link" /></td>
								<td class="b" id="country_row1<s:property value="id" />"><s:property
						...
						<%-- <td class="b" id="age_row<s:property value="id" />"><s:property
								value="url" /></td> --%>
						<!-- URL -->
						<td  class="c"><input type="button" src="image/pencil.png" width="20"
