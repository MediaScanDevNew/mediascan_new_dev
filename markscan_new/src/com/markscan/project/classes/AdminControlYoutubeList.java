...
public class AdminControlYoutubeList extends ActionSupport {
	
	private static final Logger logger = Logger.getLogger(AdminControlYoutubeList.class);
	HttpSession session2 = null;
	private BeanFactory factory = null;
	List lst = null;

	public AdminControlYoutubeList() {
