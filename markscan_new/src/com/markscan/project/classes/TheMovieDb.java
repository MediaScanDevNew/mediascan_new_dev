...
public class TheMovieDb {
	...
	public String getEnglishTvShowDtails(){
		
		try {
			int NO_OF_SEASONS = 0;
			String API_KEY = "7c619719f398bf4e91191231112c0236";
			String SEASON_NAME = "spinning out";
	...
	public HashMap<String,String> searchSeasons(TmdbApi tmdbApi, String seriesName) {
    	...
    	System.out.println("tvResults size is ---444444444444444444444444444--> : "+ tvResults.getResults().size());
