 ...
 *
 */
public class IpDomainLookup {

	/**
	 * 
	 */
	public IpDomainLookup() {
		// TODO Auto-generated constructor stub
	}

	String zip, country, city, org, timezone, isp, query, regionName, lon, as, countryCode, region, lat, status,
			message, domain;
	String domain_name, registry_domain_id, registrar_whois_server, registrar_url, updated_date, creation_date,
			registry_expiry_date, registrar_registration_expiration_date, registrar, registrar_iana_id,
			registrar_abuse_contact_email, registrar_abuse_contact_phone, reseller, domain_status,
			registry_registrant_id, registrant_name, registrant_organization, registrant_street, registrant_city,
			registrant_state_province, registrant_postal_code, registrant_country, registrant_phone,
			registrant_phone_ext, registrant_fax, registrant_fax_ext, registrant_email, registry_admin_id, admin_name,
			admin_organization, admin_street, admin_city, admin_state_province, admin_postal_code, admin_country,
			admin_phone, admin_phone_ext, admin_fax, admin_fax_ext, admin_email, registry_tech_id, tech_name,
			tech_organization, tech_street, tech_city, tech_state_province, tech_postal_code, tech_country, tech_phone,
			tech_phone_ext, tech_fax, tech_fax_ext, tech_email, registry_billing_id, billing_name, billing_organization,
			billing_street, billing_city, billing_state_province, billing_postal_code, billing_country, billing_phone,
			billing_phone_ext, billing_fax, billing_fax_ext, billing_email, name_server, dnssec;
	
	

	public String getRegistrar_registration_expiration_date() {
		return registrar_registration_expiration_date;
	}

	public void setRegistrar_registration_expiration_date(String registrar_registration_expiration_date) {
		this.registrar_registration_expiration_date = registrar_registration_expiration_date;
	}
	...
	public void setBilling_phone_ext(String billing_phone_ext) {
		this.billing_phone_ext = billing_phone_ext;
	}

	public String getBilling_fax_ext() {
		return billing_fax_ext;
	}

	public void setBilling_fax_ext(String billing_fax_ext) {
		this.billing_fax_ext = billing_fax_ext;
	}
