 ...
 *
 */
public class BL_infringing_source {

	/**
	 * 
	 */
	public BL_infringing_source() {
	...
	private int userid, souce_link_not_found, row_in_use, projectid, qc, data_move_s, data_move_i;
	...
	public int getData_move_s() {
		return data_move_s;
	}

	public void setData_move_s(int data_move_s) {
		this.data_move_s = data_move_s;
	}

	public int getData_move_i() {
		return data_move_i;
	}

	public void setData_move_i(int data_move_i) {
		this.data_move_i = data_move_i;
	}
