...
public class Productivity_client_wise {

	public Productivity_client_wise() {
		// TODO Auto-generated constructor stub
	}

	int grey_list, id, client_id, source_link, infringing_link, youtube, social_media, white_list, facebook, instagram,
			twitter, vk, periscope, source_domain,infringing_domain;
	String curr_date;
