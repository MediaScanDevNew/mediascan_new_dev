...
public interface Crawle_url4Repository extends CrudRepository<com.pradeep.pj.model.Crawle_url4, Integer> {
	
	@Modifying
	@Query(value = "insert into crawle_url4 (crawle_url2,project_id,user_id,w_list,"
				   + " pipe_id,domain_name,page_no,page_rank) "
			       + "VALUES (:lnk,:prid,:uid,:wlist,:ppid,:machine,:domain,:title,:page_no,:page_rank)", nativeQuery = true)
	@Transactional
